...
public class JsonUtils {
     ...
     * @deprecated Usage of {@link LocalDate} and {@link LocalDateTime} is preferred. Use {@link
     * JsonUtils#getLocalDate(JsonObject, String)} and {@link JsonUtils#getLocalDateTime(JsonObject,
     * String)} instead.
     */
    @Deprecated
    ...
    public static <T> JsonArray toArray(final List<T> items,
                                        final Function<T, JsonElement> function) {

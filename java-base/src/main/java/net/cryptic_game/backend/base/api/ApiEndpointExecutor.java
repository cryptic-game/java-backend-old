...
import static net.cryptic_game.backend.base.utils.JsonUtils.getDate;
import static net.cryptic_game.backend.base.utils.JsonUtils.getLocalDate;
import static net.cryptic_game.backend.base.utils.JsonUtils.getLocalDateTime;
...
public abstract class ApiEndpointExecutor {
  ...
  public ApiEndpointExecutor(final String name, final ApiCollection apiCollection,
      final Method method) throws ApiParameterException {
      if (apiCollection.getName() != null) {
  ...
  protected abstract List<ApiParameterData> loadParameters(final Method method)
    ...
    for (int i = 0; i < this.parameters.size(); i++) {
      ...
      if (parameter.getType() == String.class) {
        ...
        throw new ApiException(
            "UNSUPPORTED_PARAMETER_" + parameter.getKey().toUpperCase() + "_" + parameter.getType()

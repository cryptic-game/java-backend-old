...
public class JsonBuilder {
  ...
  /**
   * Convenience method to create a new {@link JsonObject}. The newly created object contains one
   * property with an associated number value.
   *
  ...
  /**
   * Convenience method to create a new {@link JsonObject}. The newly created object contains one
   * property with an associated string value.
   *
   * @param key name of the property.
  ...
  /**
   * Convenience method to create a new {@link JsonObject}. The newly created object contains one
   * property with an associated boolean value.
   *
   * @param key name of the property.
  ...
  /**
   * Convenience method to create a new {@link JsonObject}. The newly created object contains one
   * property with an associated character value.
   *
   * @param key name of the property.
  ...
  /**
   * Convenience method to create a new {@link JsonObject}. The newly created object contains one
   * property with an associated {@link JsonElement} value.
   *
   * @param key name of the property.
  ...
  /**
   * Convenience method to create a new {@link JsonObject}. The newly created object contains one
   * property, named "error" with an associated string value.
   *
  ...
  /**
   * Convenience method to add a new property associated with a {@link List} value. List can have
   * {@link String}, {@link Number}, {@link Boolean} or {@link Character} values.
   *
   * @param key name of the property.
   ...
   */
  public <T> JsonBuilder add(final String key, final List<T> values)
    ...
    for (T value : values) {
      if (value instanceof String) {
        ...
        throw new InvalidPropertiesFormatException(
            value.getClass() + " can not be added to a JsonArray!");
      }
    }
  ...
  /**
   * Creates a {@link JsonObject} containing all previously to the object of {@link JsonBuilder}
   * added properties.
   *

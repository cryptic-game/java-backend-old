...
public final class WebSocketLogger extends MessageToMessageCodec<JsonElement, JsonElement> {
  ...
  @Override
  protected void encode(final ChannelHandlerContext ctx, final JsonElement msg,
  ...
  @Override
  protected void decode(final ChannelHandlerContext ctx, final JsonElement msg,
      final List<Object> out) throws Exception {

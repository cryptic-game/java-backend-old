...
public class FileWrapper {
    ...
    private static File createFile(final Device device, final String name, final String contents, final boolean isDirectory, final File parentDir) {
    ...
    public static File createFile(final Device device, final String name, final String contents, final File parentDir) {

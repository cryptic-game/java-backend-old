...
public class Invitation extends TableModel {
    ...
    public DeviceImpl getInviter() {
        return this.inviter;
    }

    public void setInviter(final DeviceImpl inviter) {
    ...
    public static class InvitationKey implements Serializable {
        ...
        public InvitationKey(final Network network, final DeviceImpl device) {

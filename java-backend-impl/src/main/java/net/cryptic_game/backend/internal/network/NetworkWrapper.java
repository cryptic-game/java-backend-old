...
import net.cryptic_game.backend.internal.network.member.MemberWrapper;
...
public class NetworkWrapper {
    ...
    public static Network createNetwork(final String name, final DeviceImpl owner, final boolean hidden) {
    ...
    public static void updateOwner(final Network network, final DeviceImpl owner) {
        network.setOwner(owner);
        updateNetwork(network);
    }
    ...
    public static void addDevice(final Network network, final DeviceImpl device) {
        MemberWrapper.createMembership(network, device);
    }

    public static boolean areDevicesConnected(DeviceImpl device1, DeviceImpl device2) {
